			...
			<ul>
				...
				<c:choose>
					...
					<c:when test="${session != null}">
						...
						<li><a href="Controller?page=userinfo&username=<c:out value="${username }"/>">My Account(<c:out value="${username }"></c:out>)</a></li>
					</c:when>
				</c:choose>
 				...
 				<div class="col-md-8"><!-- right -->
					...
					<input type="submit" value="Go!">
 					...
 					<c:forEach items="${list }" var="product">
		 					...
		 					<div class="col-md-4">
		 						<img src="${product.getImage() }" class="img-responsive" style="height: 170px;"><br>
		 						<div class="text-center"><a style="color: black;"><c:out value="${product.getName() }"></c:out></a></div>	
		 						<p style="text-align: center;"><c:out value="${ product.getPrice() }"></c:out> VND</p>
