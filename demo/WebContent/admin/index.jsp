	...
	<h2>Products List:</h2>
		 ...
		 <c:forEach items="${result.rows }" var="row">
		  <table style="table-layout: fixed;width: 100%;">
				...
				<tr>
					<td style="width: 50px;"><c:out value="${row.productid }"></c:out></td>
					...
					<td style="width: 100px;"><a href="<%= request.getContextPath() %>/admin?page=edit&id=${row.productid }" style="color: #6bb1f8;">edit</a> ||
					<a href="<%= request.getContextPath() %>/admin?page=delete&id=${row.productid }" style="color:#6bb1f8;">delete</a></td>
				</tr>
			</table>
		 </c:forEach>
		 </div>
